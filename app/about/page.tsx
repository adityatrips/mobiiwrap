...
const AboutPage = () => {
  return (
    <div className='flex flex-col gap-8 justify-center min-h-nav-full mx-auto container px-6 py-10 bg-white dark:bg-black text-gray-800 dark:text-gray-300 transition-all duration-300'>
      {/* Header Section */}
      <div className='text-center'>
        <p className='text-xs uppercase tracking-widest font-semibold text-gray-600 dark:text-gray-400'>
          Why Choose Us?
        </p>
      ...
      <div className='flex flex-col md:flex-row items-center gap-6 mt-6'>
        <div className='flex-1 text-base leading-relaxed text-gray-600 dark:text-gray-300'>
          <p>
      ...
      <div className='grid grid-cols-1 md:grid-cols-3 gap-8 mt-8'>
        <div className='flex flex-col items-center bg-gray-100 dark:bg-gray-800 rounded-lg shadow-md p-6'>
          <Phone className='text-4xl text-black dark:text-white mb-4' />
        ...
        <div className='flex flex-col items-center bg-gray-100 dark:bg-gray-800 rounded-lg shadow-md p-6'>
          <Headphones className='text-4xl text-black dark:text-white mb-4' />
          <h3 className='text-lg font-semibold text-gray-800 dark:text-gray-100'>
            Earphone Skins
          </h3>
          <p className='text-center text-gray-600 dark:text-gray-400'>
        ...
        <div className='flex flex-col items-center bg-gray-100 dark:bg-gray-800 rounded-lg shadow-md p-6'>
          <Star className='text-4xl text-black dark:text-white mb-4' />
          <h3 className='text-lg font-semibold text-gray-800 dark:text-gray-100'>
            Quality Assurance
          </h3>
          <p className='text-center text-gray-600 dark:text-gray-400'>
