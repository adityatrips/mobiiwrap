...
//       setSortedProducts(productsQuery.data.data);
//     }
...
//       <CustomProducts products={sortedProducts} />
...
// const CustomProducts = ({ products }: { products: Product[] }) => (
...
const Products = () => {
  ...
  return !productsQuery.isSuccess ? (
    ...
    <div className="flex flex-col items-center justify-center gap-5">
      ...
      <CustomProducts products={currentProducts} />
